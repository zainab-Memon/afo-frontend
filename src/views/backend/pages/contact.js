            ...
            <Col lg="12" sm="12">
              <Row className="contact-detail text-center">
                <Col md="4">
                  ...
                  <div className="icon-box-content">
                    ...
                    <p className="icon-box-description"> New York</p>
                  </div>
                </Col>
                <Col md="4">
                ...
                <Col md="4">
                  <div className="iq-contact-list" data-element_type="column">
                    ...
                    <div className="icon-box-content">
                      ...
                      <p className="icon-box-description">support@afo.com</p>
                    </div>
                  </div>
                </Col>
              </Row>
              <div className="text-center iq-title-box iq-box iq-title-default">
                ...
                <p className="iq-title-desc">
                  Fill up this form to reach our stunning AFO Media team and
                  click on send message.{" "}
                </p>
              </div>
              <div className="wrapper">
                <Form
                  action="/wp-themes/streamit_wp/contact/#wpcf7-f6-p5048-o1"
                  method="post"
