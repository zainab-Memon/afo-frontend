...
import aboutus2 from "../../../assets/images/about-us/02.jpg";
import aboutus3 from "../../../assets/images/about-us/03.jpg";
import aboutus4 from "../../../assets/images/about-us/04.jpg";
import aboutus5 from "../../../assets/images/about-us/05.jpg";
import aboutus6 from "../../../assets/images/about-us/06.jpg";
    ...
    <>
      ...
      <main id="main" className="site-main">
          ...
          <Row>
            <Col lg="12" sm="12" className="mb-sm-4">
              <div className="text-center iq-title-box iq-title-default">
                <h2 className="iq-title text-capitalize">Masterminds team</h2>
                <p className="iq-title-desc">
                  AFO Media is build by one of the best and well experienced web
                  developers and an <br />
          ...
          <Row className="about-us-detail">
            <Col md="3" className="mb-4">
              ...
              <div className="icon-box-content">
                ...
                <div className="widget-container">
                  <h4 className="heading-title size-default">Lorem Ipsum</h4>
                </div>
              </div>
            </Col>
            <Col md="3" className="mb-4">
        ...
        <Container fluid className="p-0">
          <div className="map-container" style={{ left: "0px" }}>
            <Container>
              <Row className="about-us-row text-center align-items-center">
                ...
                <Col md="6">
                  <div className="text-left iq-title-box iq-title-default">
                    ...
                    <p className="iq-title-desc">
                      AFO Media lorem Ipsum sdfdsfsdsdsdsds{" "}
                      <Link to="#">hello@afo.com</Link> for any tech-related
                      support and assistance. We love to hear from our users.
                    </p>
        ...
        <Container fluid>
          <div className="svg-header">
            <div className="svg-mini-header">
              <div className="text-center iq-title-box iq-title-default">
                <h2 className="iq-title">Work With the Best</h2>
              </div>
            </div>
          </div>
        </Container>
                  ...
                  <g>
                    ...
                    <g id="XMLID_5_">
                      ...
                      <path
                        id="XMLID_84_"
                        className="st11"
                        d="M100.9,1462.4H59v-277.7h119.1v42.1h-77.3v75.7h56.5v42.1h-56.5V1462.4z"
                      ></path>{" "}
                      <path
                        id="XMLID_82_"
                        className="st11"
                        d="M248.8,1462.4h-41.9V1185h41.9V1462.4z"
                      ></path>{" "}
                      <path
                        id="XMLID_80_"
                        className="st11"
                        d="M400.2,1462.4h-114V1185h41.9v235.8h72.2V1462.4z"
                      ></path>{" "}
                      <path
                        id="XMLID_78_"
                        className="st11"
                      ...
                      <path
                        id="XMLID_73_"
                        className="st11"
                        d="M948.5,1462.4h-41.9V1185h41.9V1462.4z"
                      ></path>{" "}
                      <path
                        id="XMLID_67_"
                        className="st11"
                      ...
                      <path
                        id="XMLID_39_"
                        className="st11"
                        d="M1162.2,1462.4v-277.7h119.1v42.1H1204v75.7h56.5v42.1H1204v75.7h77.3v42.1H1162.2z"
                      ></path>{" "}
                      <path
                        id="XMLID_34_"
                        className="st11"
                      ...
                      <path
                        id="XMLID_21_"
                        className="st11"
                        d="M1516.1,1227h-44.5V1185h130.6v42.1h-44.3v235.4h-41.8V1227z"
                      ></path>{" "}
                      <path
                        id="XMLID_9_"
                        className="st11"
                ...
                >
                  <g id="Layer_1">
                    ...
                    <g>
                      ...
                      ></path>{" "}
                      <path className="st7" d="M445.1,683.6h-39.5"></path>{" "}
                      <path className="st7" d="M484.2,683.6"></path>{" "}
                      <path className="st7" d="M557.1,683.6"></path>{" "}
                      <path className="st7" d="M621.8,683.6"></path>{" "}
                    </g>{" "}
                    <g>
                      {" "}
                      <path
